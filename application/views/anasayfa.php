...
<body>
    ...
    <header class="intro-header" style="background-image: url('<?php echo base_url();?>img/about-bg.jpg')">
        <div class="container">
            <div class="row">
     ...
     <?php
          foreach ($bilgiler as $bilgi) {
            ...
            if($bilgi->file_name==null)
            {
               
                echo "<img src=".base_url()."img/icon.jpg class='image--cover'>"."</img>";
            }
            else
            {
                 echo img(array('width'=>'120','height'=>'80','src'=>'upload/'.$bilgi->file_name, 'class'=>'image--cover'));
            }
     ...
     ?>
                        ...
                        <?php 
                          foreach ($bilgiler as $bilgi) {
                          	 echo  "<h1>".$bilgi->ad ." ". $bilgi->soyad."</h1>"."<br/>";
                          	 echo  $bilgi->kullaniciAdi ."<br/>";
                          	 echo  $bilgi->email. "<br/>";
                             echo "<hr class='small'>"."<span class='subheading'>".$bilgi->kendiniTanit."</span>";
     	 
                          }
                            
                         ?>
                        
                        <a href="<?php echo base_url();?>index.php/profil_guncelle_controller/index" style="color:white;">Update Profile</a>
                    </div>
                </div>
            </div>
        </div>
