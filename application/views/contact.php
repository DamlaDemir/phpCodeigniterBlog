    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <form name="sentMessage"  action="<?php echo base_url()?>index.php/contact_controller/mailGonder" method="post">
                    ...
                    <div class="row">
                        <div class="form-group col-xs-12">
                            <button type="submit" class="btn btn-default" name="mailGonder">Send</button>
                        </div>
                    </div>
                </form>
            </div>
